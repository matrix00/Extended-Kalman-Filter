...
void FusionEKF::ProcessMeasurement(const MeasurementPackage &measurement_pack) {
  ...
  if (!is_initialized_) {
    ...
    */
	...
	ekf_.x_ << measurement_pack.raw_measurements_[0], measurement_pack.raw_measurements_[1], measurement_pack.raw_measurements_[2], 0;
      ...
      Initialize state.
      */
        cout << "Fusion: initializing LASER " << endl;
  ...
  //compute the time elapsed between the current and previous measurements
        ...
        cout << "Fusion: update transition matrix " << endl;
	float noise_ax =9;
	float noise_ay = 9;
  ...
  // print the output
  cout << "update done x_ = " << ekf_.x_ << endl;
  cout << "update done P_ = " << ekf_.P_ << endl;
}
